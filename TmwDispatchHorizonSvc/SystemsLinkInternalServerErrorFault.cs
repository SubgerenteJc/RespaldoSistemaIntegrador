...
// Type: WindowsFormsApp1.TmwDispatchHorizonSvc.SystemsLinkInternalServerErrorFault
...
namespace WindowsFormsApp1.TmwDispatchHorizonSvc
{
  ...
  [DataContract(Name = "SystemsLinkInternalServerErrorFault", Namespace = "TMWSystems.SystemsLink.Services.ServiceFaults")]
  [Serializable]
  public class SystemsLinkInternalServerErrorFault : IExtensibleDataObject, INotifyPropertyChanged
  {
    [NonSerialized]

...
// Type: WindowsFormsApp1.TmwDispatchHorizonSvc.ConcurrencyNestedAndValidityBase
...
namespace WindowsFormsApp1.TmwDispatchHorizonSvc
{
  ...
  [DataContract(Name = "ConcurrencyNestedAndValidityBase", Namespace = "http://schemas.datacontract.org/2004/07/TMWSystems.MiddleTier.Core.Contracts.Models.Base")]
  ...
  [Serializable]
  public class ConcurrencyNestedAndValidityBase : ConcurrencyBaseNested
  {
    [OptionalField]

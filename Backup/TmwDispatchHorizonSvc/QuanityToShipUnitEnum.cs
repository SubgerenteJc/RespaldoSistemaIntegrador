...
// Type: WindowsFormsApp1.TmwDispatchHorizonSvc.QuanityToShipUnitEnum
...
namespace WindowsFormsApp1.TmwDispatchHorizonSvc
{
  ...
  [DataContract(Name = "QuanityToShipUnitEnum", Namespace = "http://schemas.datacontract.org/2004/07/TMWSystems.SystemsLinkShared.Enumerations")]
  public enum QuanityToShipUnitEnum
  {
    [EnumMember] ITEM,
    [EnumMember] CASE,
    [EnumMember] PALLET,

...
// Type: WindowsFormsApp1.TmwDispatchHorizonSvc.ArriveDepartEnum
...
namespace WindowsFormsApp1.TmwDispatchHorizonSvc
{
  ...
  [DataContract(Name = "ArriveDepartEnum", Namespace = "http://schemas.datacontract.org/2004/07/TMWSystems.MiddleTier.Shared.Enumerations")]
  public enum ArriveDepartEnum
  {
    [EnumMember] Arrive,
    [EnumMember] Depart,
  }
